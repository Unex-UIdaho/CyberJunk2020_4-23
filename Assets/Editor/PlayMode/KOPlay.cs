    ...
    public class KOPlay
    {
        ...
        public IEnumerator Stress() //This one piggy backs of the other where the scene is alredy loaded
        {
            ...
            while (fps > 15f)
            {
                ...
                GameObject weapon = GameObject.Instantiate(weaponObject, new Vector3(2, -12, 0), Quaternion.identity) as GameObject;
                ...
                deltaTime /= 2.0;
                fps = 1.0 / deltaTime;
                weaponScript.shootCheck = true; //SHOOT CHECK IN GUNSCRIPT NEEDS TO BE A PUBLIC VAR TO WORK
                // Debug.log("Count: " + i);
                //i++;
